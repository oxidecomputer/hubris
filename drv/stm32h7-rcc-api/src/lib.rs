...
//
const fn ahb1(bit: u32) -> u32 {
    0 * 32 + bit
}

const fn ahb2(bit: u32) -> u32 {
    (1 * 32) + bit
}

const fn ahb3(bit: u32) -> u32 {
    (2 * 32) + bit
}

const fn ahb4(bit: u32) -> u32 {
    (3 * 32) + bit
}

const fn apb1l(bit: u32) -> u32 {
    (4 * 32) + bit
}

const fn apb1h(bit: u32) -> u32 {
    (5 * 32) + bit
}

const fn apb2(bit: u32) -> u32 {
    (6 * 32) + bit
}

const fn apb3(bit: u32) -> u32 {
    (7 * 32) + bit
}

const fn apb4(bit: u32) -> u32 {
    (8 * 32) + bit
}
