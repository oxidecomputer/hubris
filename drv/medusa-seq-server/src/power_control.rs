...
impl PowerControl {
    pub fn new() -> Self {
        ...
        // enable pin
        let v1p0_front_phy =
            PowerRail::new(Port::I.pin(11), Port::I.pin(12), RailName::V1P0FrontPhy);
        let v2p5_front_phy =
            PowerRail::new(Port::I.pin(11), Port::I.pin(13), RailName::V2P5FrontPhy);

        // The local VSC8562 rails are generated from the same LDO which shares an
        // enable pin
        let v1p0_local_phy =
            PowerRail::new(Port::J.pin(10), Port::J.pin(11), RailName::V1P0LocalPhy);
        let v2p5_local_phy =
            PowerRail::new(Port::J.pin(10), Port::J.pin(12), RailName::V2P5LocalPhy);
