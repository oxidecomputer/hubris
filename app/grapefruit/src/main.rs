...
fn system_init() {
    ...
    // able to read the pins right away, because they have pull-up/down
    // resistors populated on the board.
    ...
    cfg_if::cfg_if! {
        if #[cfg(target_board = "grapefruit-a")] {
            let expected_rev = 0b000;
        } else if #[cfg(target_board = "grapefruit-b")] {
