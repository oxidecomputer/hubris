...
Rust API. There is also experimental support for an IDL generator called
https://github.com/oxidecomputer/idolatry[Idolatry]. The general pattern for
writing these by hands is:
