...
pub const SIZE: usize = 418;
pub const SERIAL_NUMBER_RANGE: Range<usize> = 15..16;
pub const PUB_RANGE: Range<usize> = 212..244;
pub const SIG_RANGE: Range<usize> = 354..418;
pub const SIGNDATA_RANGE: Range<usize> = 4..344;
pub const FWID_RANGE: Range<usize> = 312..344;
pub const CERT_TMPL: [u8; 418] = [
    0x30, 0x82, 0x01, 0x9e, 0x30, 0x82, 0x01, 0x50, 0xa0, 0x03, 0x02, 0x01,
    ...
    0x35, 0x39, 0x35, 0x39, 0x5a, 0x30, 0x49, 0x31, 0x0b, 0x30, 0x09, 0x06,
    ...
    0x6f, 0x72, 0x75, 0x6d, 0x2d, 0x64, 0x68, 0x65, 0x30, 0x2a, 0x30, 0x05,
