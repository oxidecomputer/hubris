...
The `Tech Port Unlock` public keys were extracted from the Online Signing Service via:

```
ssh-keygen -i -m PKCS8 -f <(permslip --url=https://signer-us-west.corp.oxide.computer public-key "Tech Port Unlock Production 1")
