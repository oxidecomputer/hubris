...
pub fn config(
    ...
    let mut flash = match board {
        ...
        | "gimletlet-2" | "gimletlet-front-io" | "gimlet-b" | "gimlet-c"
        | "gimlet-d" | "gimlet-e" | "gimlet-f" | "psc-a" | "psc-b"
...
pub fn chip_name(board: &str) -> anyhow::Result<&'static str> {
    let b = match board {
        ...
        "gemini-bu-1" | "gimletlet-1" | "gimletlet-2"
        | "gimletlet-front-io" | "gimlet-b" | "gimlet-c" | "gimlet-d"
        | "gimlet-e" | "gimlet-f" | "psc-a" | "psc-b" | "psc-c"
        | "sidecar-b" | "sidecar-c" | "sidecar-d" => "STM32H753ZITx",
