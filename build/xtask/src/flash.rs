...
pub fn config(
    ...
    let mut flash = match board {
        ...
        | "gimletlet-2" | "gimlet-a" | "gimlet-b" | "gimlet-c" | "psc-b"
        | "sidecar-a" | "sidecar-b" | "stm32g031-nucleo" | "donglet-g030"
...
pub fn chip_name(board: &str) -> anyhow::Result<&'static str> {
    let b = match board {
        "lpcxpresso55s69" | "rot-carrier-2" | "gimlet-rot-c" => {
            "LPC55S69JBD100"
        }
        ...
        | "gimlet-b" | "gimlet-c" | "psc-b" | "sidecar-a" | "sidecar-b" => {
            "STM32H753ZITx"
        }
