...
pub enum Functions {
    ...
    #[cfg(feature = "gpio")]
    GpioInput(drv_stm32l0_sys_api::Port, drv_stm32l0_sys_api::GpioError),
    #[cfg(feature = "gpio")]
    GpioToggle(
        (drv_stm32l0_sys_api::Port, u8),
        drv_stm32l0_sys_api::GpioError,
    ),
    #[cfg(feature = "gpio")]
    GpioSet(
        (drv_stm32l0_sys_api::Port, u8),
    ...
    GpioConfigure(
        (
            drv_stm32l0_sys_api::Port,
            u8,
            drv_stm32l0_sys_api::Mode,
            drv_stm32l0_sys_api::OutputType,
            drv_stm32l0_sys_api::Speed,
            drv_stm32l0_sys_api::Pull,
            drv_stm32l0_sys_api::Alternate,
        ),
        drv_stm32l0_sys_api::GpioError,
    ),
}
...
fn gpio_args(
    stack: &[Option<u32>],
) -> Result<(drv_stm32l0_sys_api::Port, u16), Failure> {
    if stack.len() < 2 {
    ...
    let port = match stack[fp + 0] {
        Some(port) => match drv_stm32l0_sys_api::Port::from_u32(port) {
            Some(port) => port,
...
fn gpio_input(
    ...
    let gpio = drv_stm32l0_sys_api::Sys::from(task);
