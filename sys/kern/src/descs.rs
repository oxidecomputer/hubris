...
pub struct RegionDesc {
    ...
    ///
    /// This is pointer-sized rather than `u32` so that the kernel can describe
    /// regions of a host address space when built for simulation; on the
    /// 32-bit targets Hubris runs on, the layout is unchanged.
    pub base: usize,
